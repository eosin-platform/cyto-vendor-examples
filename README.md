...
| **MitoEM**                              | Volume EM (mitochondria)                  | Download                | **2**   | ➖       | Planned — segmentation benchmark                                           |
| **SNEMI3D**                             | Connectomics EM                           | Download                | **2**   | ➖       | Planned — classic segmentation dataset                                     |
| **CREMI**                               | Connectomics EM                           | Download                | **2**   | ➖       | Planned — EM segmentation benchmark                                        |
| **Kasthuri EM / MICrONS**               | Volume EM (neurons, synapses)             | Python API + download   | **2**   | ❌       | Planned — massive connectomics datasets                                   |
| **EPFL CVLab EM**                       | 2D EM segmentation                        | Download                | **3**   | ➖       | Planned — small classic EM datasets                                       |
